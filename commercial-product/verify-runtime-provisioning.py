...
def main() -> int:
    ...
    script_requirements = {
        ...
        "install-whisper.ps1": ("AcceptLicense", "runtime-source-lock.json", "Verify-Hash", "Download-Verified", "revision", "HF_HUB_OFFLINE", "ProxyUrl", "DownloadProxyUrl", "--continue-at", "faster-whisper-LICENSE.txt", "licenseEvidence", "usagePolicy", "runtime.json", "Commit-Install", ".installing-", "BOSSAI_DONE"),
    }
